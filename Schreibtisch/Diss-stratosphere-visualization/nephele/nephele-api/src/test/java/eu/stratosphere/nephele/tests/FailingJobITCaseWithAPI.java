package eu.stratosphere.nephele.tests;
...
* @author warneke
*/
public class FailingJobITCaseWithAPI {
	...
	public final static class InnerTask extends AbstractTask {
		...
		public void registerInputOutput() {
			...
			this.recordWriter = new RecordWriter<FailingJobRecord>(this);
			this.recordReader = new MutableRecordReader<FailingJobITCaseWithAPI.FailingJobRecord>(this);
		}
	...
	/**
	 * This test checks Nephele's fault tolerance capabilities by simulating a 
	 * successively failing one inner vertices.
	 */
	@Test
	...
	/**
	 * This test checks Nephele's fault tolerance capabilities by simulating 
	 * a failing inner vertex without all tasks
	 * checkpointing.
	 */
	@Test
