...
public interface InstanceManager {
	...
	/**
	 * Returns the LocalTaskManagerThread from this Instance Manager
	 * @return the LocalTaskManagerThread from this Instance Manager
	 * @author bel
	 */
	LocalTaskManagerThread getLocalTaskManagerThread();
}
