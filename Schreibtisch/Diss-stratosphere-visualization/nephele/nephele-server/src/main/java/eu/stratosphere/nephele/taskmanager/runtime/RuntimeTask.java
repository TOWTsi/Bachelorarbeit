...
public final class RuntimeTask implements Task, ExecutionObserver {
	...
	/**
	 * This String can contain Information about the reason why a checkpoint was set
	 */
	private String whyCheckpointing;
	
	/**
	 * The DefaultRoutingService sets the taskContext. 
	 * The Task Context is needed for further Information about the Ephemeral Checkpoints
	 */
	private RuntimeTaskContext taskContext;
...
//		}
	...
	public TaskContext createTaskContext(final RoutingService routingService,
		...
		this.taskContext = new RuntimeTaskContext(this, this.initialCheckpointState, routingService);
	...
	/**
	 * Sets a String with the reason why the checkpoint is set
	 * @param why The reason, why the Checkpoint is set
	 * @author bel
	 */
	public void setWhyCheckpointing(String why) {
		this.whyCheckpointing = new String(why);
	}
	
	/**
	 * Gets the String with the reason, why a checkpoint was set
	 * @return
	 * @author bel
	 */
	public String getWhyCheckpointing() {
		return this.whyCheckpointing;
	}
	
	/**
	 * Returns the Ephemeral Checkpoint, if it exists.
	 * @return The Ephemeral Checkpoint, if it exists.
	 */
	public EphemeralCheckpoint getEphemeralCheckpoint() {
		return this.taskContext.getEphemeralCheckpoint();
	}
}
